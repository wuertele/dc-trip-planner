...
create policy "Public read DC trip rankings"
on public.trip_rankings
for select
to anon
using (trip_id = 'washington-dc-2027');

create policy "Public insert DC trip rankings"
on public.trip_rankings
for insert
to anon
with check (trip_id = 'washington-dc-2027');

create policy "Public update DC trip rankings"
on public.trip_rankings
for update
to anon
using (trip_id = 'washington-dc-2027')
